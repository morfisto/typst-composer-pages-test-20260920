#import "content.typ": template-content
  ...
  html.html(
    lang: lang,
    {
      ...
      html.body({
        ...
        html.elem("header", attrs: (class: "site-header", "data-composer-settings": "header"),
          {
        ...
        html.elem("header", attrs: (class: "site-header", "data-composer-settings": "navigation"),
        ...
        html.elem("footer", attrs: ("data-composer-settings": "footer"), {
